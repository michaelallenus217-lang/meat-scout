"""Scraper for Fred Meyer (Lakewood, WA) meat prices."""
...
# Everyday (non-sale) prices — verified from fredmeyer.com and in-store
KNOWN_PRICES = [
    ...
    {"store": STORE_NAME, "cut": "Whole Chicken", "price_per_lb": 2.29, "sale_end_date": None},
    {"store": STORE_NAME, "cut": "Pork Tenderloin", "price_per_lb": 5.49, "sale_end_date": None},
    {"store": STORE_NAME, "cut": "Pork Loin Roast", "price_per_lb": 3.49, "sale_end_date": None},
    ...
    {"store": STORE_NAME, "cut": "Top Sirloin Steak", "price_per_lb": 9.49, "sale_end_date": None},
    ...
    {"store": STORE_NAME, "cut": "Sole Fillet", "price_per_lb": 8.49, "sale_end_date": None},
    {"store": STORE_NAME, "cut": "Flounder Fillet", "price_per_lb": 8.49, "sale_end_date": None},
]


def scrape_fredmeyer() -> list[dict]:
    """Return sale/ad deals from Flipp."""
    results = fetch_flipp_prices("Fred Meyer")
    if not results:
